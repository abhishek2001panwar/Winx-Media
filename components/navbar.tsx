                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-baseline gap-3 sm:gap-4">
                        ...
                        <span className="text-3xl  sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-light tracking-tight transition-all duration-500 group-hover:tracking-wide  " style={{fontFamily: `SF Pro Display regular , sans-serif`}}>
                          {item.label}
                        </span>
                      </div>
