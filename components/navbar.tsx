...
export default function Navbar() {
  ...
  return (
    <>
      {/* TOP NAV */}
      <nav
        className="fixed top-0 w-full z-[60] px-4 sm:px-5 md:px-6 py-3 sm:py-10 md:py-5 lg:py-6 border-b border-black/10 transition-all duration-500 backdrop-blur-3xl"
        style={{
