...
export default function Navbar() {
  ...
  return (
    <>
      {/* TOP NAV */}
      <nav
        className="fixed top-0 w-full z-[60] px-4 sm:px-5 md:px-6 py-2 sm:py-2 md:py-2 lg:py-2 border-b border-black/10 transition-all duration-700"
        style={{
        ...
        <div className={`max-w-7xl mx-auto flex items-center justify-between`}>
          ...
          >
            {!isMenuOpen ? (
              ...
              // Cross Icon - Same color, no spin
              <div className="relative w-7 sm:w-8 md:w-10 h-7 sm:h-8 md:h-10 flex items-center justify-center">
                <span className="absolute w-7 sm:w-8 md:w-10 h-[2px] bg-black rotate-45 transition-all duration-300" />
                <span className="absolute w-7 sm:w-8 md:w-10 h-[2px] bg-black -rotate-45 transition-all duration-300" />
              </div>
            )}
          </button>
      ...
      >
        {/* Background with solid color - slides from top */}
        <div
        ...
        <div 
          className={`absolute inset-0 opacity-[0.03] mix-blend-overlay transition-all duration-700 ${
            isMenuOpen ? "translate-y-0 opacity-[0.03]" : "-translate-y-full opacity-0"
          }`}
          style={{
        ...
        {/* Content */}
        <div
          className={`absolute inset-0 z-56 font-serif transition-all duration-700 ${
        ...
        >
          <div className="h-full flex flex-col justify-between px-4 sm:px-6 md:px-10 lg:px-16 xl:px-24 2xl:px-32 py-20 sm:py-24 md:py-28 lg:py-32">
            ...
            <div className="flex-1 flex flex-col lg:grid lg:grid-cols-[1.2fr_auto_0.8fr] gap-8 lg:gap-16 xl:gap-24">
              ...
              <div className="flex flex-col justify-center space-y-0.5 sm:space-y-1 md:space-y-0.5 lg:space-y-0.5">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-baseline gap-3 sm:gap-4">
                        ...
                        <span className="text-3xl  sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-light tracking-tight transition-all duration-500 group-hover:tracking-wide  " style={{fontFamily: `SF Pro Display, SF Pro Icons, Helvetica Neue, Helvetica, Arial, sans-serif`}}>
                          {item.label}
                        </span>
                      </div>
