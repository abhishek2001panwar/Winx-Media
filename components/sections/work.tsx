...
const StoryBeat: React.FC<{ beat: typeof storyBeats[0]; index: number }> = ({ beat, index }) => {
  ...
  return (
    <motion.div
      ...
      className={`relative p-8 md:p-12 rounded-2xl ${getTypeStyles()} mb-8`}
    >
      {/* Icon */}
      <motion.div
        ...
        className="absolute -left-6 top-8 w-12 h-12 bg-white rounded-full flex items-center justify-center text-2xl shadow-lg border-2 border-gray-200"
      >
        {beat.icon}
      </motion.div>
      ...
      <motion.div
        ...
        className="absolute top-4 right-4 px-3 py-1 bg-white/80 backdrop-blur-sm rounded-full text-xs font-mono uppercase tracking-wider text-gray-600 border border-gray-200"
      >
        {beat.type}
      </motion.div>
    </motion.div>
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="text-center mb-24">
          ...
          <div className="max-w-5xl mx-auto relative mb-8">
            {/* Background text */}
            <h2 className="text-5xl md:text-7xl lg:text-8xl font-black leading-tight text-center text-black font-serif">
              Less talking
              <br />
              More showing
            </h2>
        ...
        >
          <div className="relative p-12 bg-gradient-to-br from-gray-50 to-white rounded-3xl shadow-2xl border border-gray-200 overflow-hidden">
            {/* Decorative corner elements */}
            <div className="absolute top-0 left-0 w-32 h-32 bg-black/5 rounded-br-full" />
            <div className="absolute bottom-0 right-0 w-32 h-32 bg-black/5 rounded-tl-full" />
            ...
            <div className="relative z-10 text-center">
              ...
              <img className='rounded-3xl' src="./image.png" alt="" />
              </motion.div>
              
              {/* <p className="text-xl text-gray-600 font-light">Wedding Photo Management, Reimagined</p> */}
              
              {/* Stats */}
              <div className="grid grid-cols-3 gap-6 mt-10 pt-10 border-t border-gray-200">
                <div>
                  <div className="text-3xl font-black text-black">47K+</div>
                  <div className="text-sm text-gray-600 uppercase tracking-wide mt-1">Photos/Wedding</div>
                </div>
                <div>
                  <div className="text-3xl font-black text-black">100%</div>
                  <div className="text-sm text-gray-600 uppercase tracking-wide mt-1">AI Accuracy</div>
                </div>
                <div>
                  <div className="text-3xl font-black text-black">∞</div>
                  <div className="text-sm text-gray-600 uppercase tracking-wide mt-1">Memories Saved</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <motion.div
            ...
            className="mb-12"
          >
            <h3 className="text-3xl md:text-4xl font-black mb-4 font-serif">The Journey</h3>
            <p className="text-lg text-gray-600">From chaos to clarity, one feature at a time.</p>
          </motion.div>
          ...
          <div className="relative pl-8">
            ...
            <motion.div
              ...
              className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-gray-300 via-gray-500 to-black origin-top"
            />
        ...
        >
          <div className="relative p-16  border-l-4 border-gray-700 bg-gray-200/30 text-black border rounded-3xl overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              <h3 className="text-3xl md:text-4xl font-black mb-6 font-serif">The Result?</h3>
              ...
              >
                <a
                  href="/work"
                  className="inline-flex items-center gap-3 px-10 py-4 bg-white text-black rounded-full font-bold text-lg  hover:shadow-2xl transition-all duration-300"
                >
