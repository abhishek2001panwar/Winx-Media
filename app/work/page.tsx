  ...
  return (
    <div className="min-h-screen bg-white relative overflow-x-hidden">
      ...
      <div className="flex flex-col items-center justify-end min-h-[90vh] pb-4">
        <h2 className="mb-6 text-4xl md:text-5xl font-serif  text-center drop-shadow-lg bg-gradient-to-r from-[#181f7c] to-[#a34fdc] bg-clip-text text-transparent pb-3">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-3 mb-6 px-6 py-3 bg-black/5 rounded-full border border-black/10">
              ...
              <span className="text-sm  tracking-widest uppercase text-gray-700">Instagram Showcase</span>
            </div>
            ...
            {instagramReels.map((reel, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Number badge */}
                  <div className="absolute top-4 left-4 z-20 w-8 h-8 bg-black/60 backdrop-blur-sm rounded-full flex items-center justify-center text-white  text-sm border border-white/20">
                    {idx + 1}
                  </div>
                </motion.a>
              );
          ...
          >
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 px-8 py-4 bg-black text-white rounded-full  text-lg shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 group"
            >
